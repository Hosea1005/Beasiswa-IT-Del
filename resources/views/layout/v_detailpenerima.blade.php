        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
            ...
            <div class="table-responsive">
              <form action="/pendaftar/updatepenerima/{{ $penerima->id_pendaftaran }}" method="POST" enctype="multipart/form-data">
                @csrf
              <!-- Projects table -->
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Nim</td>
                    <td>{{ $penerima->nim_mahasiswa }}</td>
                  </tr>
                  <tr>
                    <td>Nama</td>
                    <td>{{ $penerima->nama_mahasiswa }}</td>
                  </tr>
                  <tr>
                    <td>Prodi</td>
                    <td>{{ $penerima->ps }}</td>
                  ...
                  <tr>
                    <td>Link Berkas</td>
                    <td><a href="{{ $penerima->berkas }}">{{ $penerima->berkas }}</a></td>
                  </tr>
                  <tr>
                           <td>
