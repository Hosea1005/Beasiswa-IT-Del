      ...
      <div class="row">
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
              ...
              <div class="col">
               <a href="/home/keuangankemahasiswaan"><button type="submit" name="upload" class="btn btn-sm btn-success" >Lakukan Request</button></a>
               <a href="/home/lihatdaftarpermohonan"><button disabled type="submit" name="upload" class="btn btn-sm btn-success">Lihat Daftar Permohonan</button></a>
              </div>
              ...
              <table class="table align-items-center table-flush">  
                ...
                <tbody>
                  ...
                  @php
                    ...
                    $count = DB::table('danas')->where('kd', $data->kd)->sum("jumlah");
                  @endphp
                  <tr>
                    <td>{{ $no++ }}</td>
                    <td>{{ $data->unit }}</td>
                    ...
                    <td>
                    <a href="/home/lihatpermohonan/{{ $data->id_per }}" class="btn btn-sm btn-success">Detail</a>
                    {{-- <a href="/home/cetakpdfpermohonandana/{{ $data->id_per }}" class="btn btn-sm btn-success">Cetak</a> --}}
                    </td>
