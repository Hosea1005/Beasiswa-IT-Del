...
<body>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="/home/rekomendasidosenwali">
                <!-- <i class="ni ni-tv-2 text-primary"></i> -->
                <span class="nav-link-text">Surat Rekomendasi Dosen Wali</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="/home/rekomendasikeasramaan">
                <!-- <i class="ni ni-tv-2 text-primary"></i> -->
  ...
  <div class="main-content" id="panel">
    ...
    <!-- Page content -->
    <form action="/printdosenwali" method="POST" enctype="multipart/form-data">
    @csrf
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <div class="form-group">
                      <select  name="ndw" id="" class="form-control form-control-sm">
                        <option selected>Nama Dosen Wali</option>
                          @foreach($dosen as $element_each)
                        <option value="{!! $element_each->n_dosen !!}">{!! $element_each->n_dosen !!}</option>
                        @endforeach
                      </select>
                    </div>
                  ...
                  <tr>
                    ...
                    <td>
                    <div class="form-group">
                      <select name="nidn" id="" class="form-control form-control-sm">
                        <option selected>NIDN</option>
                        @foreach($dosen as $element_each)
                        <option value="{!! $element_each->nidn !!}">{!! $element_each->nidn !!} ({!! $element_each->n_dosen !!} )</option>
                        @endforeach
                      </select>
                    </div>
