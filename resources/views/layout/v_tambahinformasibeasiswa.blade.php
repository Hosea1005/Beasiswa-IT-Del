        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
            ...
            <div class="table-responsive">
              <!-- Projects table -->
              <form action="/home/insertbea" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="col text">
                Nama Beasiswa
                <br>
                ...
                <br>
                    ...
                    <div class="form-group-right">
                    <input type="text" name="jlh_daftar" class="form-control">
                    </div>
                ...
                <br>
                    ...
                    <div class="form-group-right">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" name="deskripsi_beasiswa"></textarea>
                    </div>
                ...
                <br>
                    ...
                    <div class="form-group-right">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" name="persyaratan"></textarea>
                    </div>
                ...
                <br>
                    ...
                    <div class="form-group-right">
                      <input type="text" name="info_beasiswa" class="form-control">
                    </div>
                ...
                <br>
                    ...
                    <input type="hidden" name="curr" class="form-control" value="{{date('Y-m-d')}}">
                <div class="col text">
                Tanggal Berakhir
                <br>
