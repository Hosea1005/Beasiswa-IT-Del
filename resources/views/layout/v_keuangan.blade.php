        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Permohonan Dana Oleh Kemahasiswaan</h3>
                </div>
                <form class="navbar-search navbar-search-light form-inline float-right" id="navbar-search-main">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <form action="/home" method="GET">
                  <input class="form-control" name="cari" placeholder="Masukkan Tahun" type="search" value="{{ old('cari') }}">
              ...
              <table class="table align-items-center table-flush">  
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="/home/lihatpermohonan/keu/{{ $data->id_per }}" class="btn btn-sm btn-primary">Detail</a>
