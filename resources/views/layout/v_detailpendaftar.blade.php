        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
            ...
            <div class="table-responsive">
              <form action="/pendaftar/updatependaftar/{{ $pendaftar->id_pendaftaran }}" method="POST" enctype="multipart/form-data">
                @csrf
              <!-- Projects table -->
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Link Berkas</td>
                    <a href=""><td>www.google.drive.com</td></a>
                  </tr>
                  ...
                  <tr>
                         ...
                         <tr>
                           ...
                           <div class="form-group">
                            <select name="status_daftar" id="" class="form-control form-control-sm">
              ...
              <button class="btn btn-success float-right" style="margin-right: 20px; margin-bottom:20px">Submit</button>
              </form>
            </div>
        </div>
        </div>
