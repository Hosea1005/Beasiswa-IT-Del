        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Informasi Beasiswa</h3>
                </div>
                <div class="col text-right">
                  <a href="/home/tambahinformasibeasiswa" class="btn btn-sm btn-success">Tambah</a>
            ...
            ?> 
                    ...
                    @endif</td>
                    <td>
                      <a href="/home/detailbeasiswakemahasiswaan/{{ $data->id_beasiswa }}" class="btn btn-sm btn-primary">Detail</a>
