      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="/home/datamahasiswapendaftar">
                <!-- <i class="ni ni-tv-2 text-primary"></i> -->
        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Daftar Mahasiswa Pendaftar</h3>
                </div>
            ...
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <form action="/home/datamahasiswapendaftar" method="GET">
                  <select class="form-control" id="exampleFormControlSelect1" name="sr">
                    <option value="ipk">IPK</option>
                    <option value="peng">Pengasilan Orang Tua</option>
                  </select>
                ...
                <tbody>
                 @foreach ($pendaftar as $data)
                  ...
                  <tr>
                    ...
                    @endif</td>
                    <td>
                      <a href="/home/detailpendaftar/{{ $data->id_pendaftaran }}" class="btn btn-sm btn-primary">Detail</a>
                      {{-- <a href="/home/ubahdatamahasiswapendaftar" class="btn btn-sm btn-primary">Ubah</a> --}}
                      <a href="/home/deletependaftar/{{ $data->id_pendaftaran }}"" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
