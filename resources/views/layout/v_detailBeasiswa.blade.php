  ...
  <div class="main-content" id="panel">
    ...
    <!--Table 2-->
        ...
        <div class="col-xl-12">
          ...
          <div  class="container-fluid"><a href="/home/daftarbeasiswa/{{ $beasiswa->id_beasiswa }}"><button type="button" class="btn btn-primary  float-right">Daftar</button></a></div>
          </span>
          </div>
        </div>
