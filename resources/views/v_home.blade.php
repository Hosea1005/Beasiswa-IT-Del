...
<body>
          ...
          <ul class="navbar-nav">
            ...
            <!-- <li class="nav-item">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="/home/rekomendasikeasramaan">Keasramaan</a>
                </div>
              </li>
            </li> -->
  ...
  <div class="main-content" id="panel">
            ...
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <form action="/home" method="GET">
                  <input class="form-control" name="cari2" placeholder="Cari Nama Beasiswa" type="search" value="{{ old('cari2') }}">
    ...
    <!--Table 2-->
          ...
          <form class="navbar-search navbar-search-light form-inline float-right" id="navbar-search-main">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <form action="/home" method="GET">
                  <input class="form-control" name="search" placeholder="Cari Nama Pengumuman" type="search" value="{{ old('cari') }}">
                  <input type="submit" class="btn btn-primary" value="Cari">
                </form>
        ...
        <tr> 
            <td><a href="/home/detail/{{ $data->id_peng }}">{{ $data->judul_peng }}</a></td>
           <td>{{ $data->current }}</td>
           <td>{{ $data->craetor }}</td>
        </tr>
        @endforeach
